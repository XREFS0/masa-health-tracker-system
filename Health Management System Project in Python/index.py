    ...
    if Admin_user_mode == "1":
                ...
                if AdminOptions == "1":
                    ...
                    if Admin_choice == "1":
                        try:
                            ...
                            while member_ID in Members_DataBase:
                        ...
                        try:
                            ...
                            while True:
                                ...
                                if Admin_choice == "1":
                                    ...
                                    print(
                                        "----------------------Member original weight edited successfully----------------------"
                                    )
                                elif Admin_choice == "8":
                                    Members_DataBase[member_ID][7] = input("\nEnter member current weight : ")
                                    print(
                                        "----------------------Member current weight edited successfully----------------------"
                                    )

                                elif Admin_choice == "9":
                                    Members_DataBase[member_ID][8] = input("\nEnter member Phone Number : ")
                                    print(
                                        "----------------------Member Phone Number edited successfully----------------------"
                                    )
                    ...
                    if Admin_choice == "1":
                        try:
                            ...
                            while Coach_ID in Coaches_DataBase:
                        ...
                        try:
                            ...
                            print(
                                "/----------------------Coach data deleted successfully----------------------/"
                            )
                        except:
                            print("Coach ID should be an integer number")
                    ...
                    if Admin_choice == "1":
                        try:
                            ...
                            while Coach_ID not in Coaches_DataBase:
                                Coach_ID = int(
                                    input("Doctor ID incorrect, Please enter a correct coach ID : ")
                                )
                            print("---------------------------------------------------------")
                            print(
                                "|For book an appointment for an exist member Enter 1   |\n|For book an appointment for a new member Enter 2      |\n|To be Back Enter E                                     |"
                            )
                            print("---------------------------------------------------------")
                            Admin_choice = input("Enter your choice : ")
                            Admin_choice = Admin_choice.upper()
                            if Admin_choice == "1":
                                ...
                                while member_ID not in Members_DataBase:
                                    member_ID = int(
                                        input("Incorrect ID, please Enter a correct member ID : ")
                                    )
                        ...
                        try:
                            ...
                            try:
                                ...
                                Coaches_DataBase[PairKey][AppointmentIndex] = [
                                    member_ID,
                                    Session_Start,
                                    Session_End,
                                ]
        ...
        while True:
            ...
            if UserOptions == "1":
                ...
                for i in Coaches_DataBase:
                    print(
                        "	Name : " + Coaches_DataBase[i][0][0],
                        "Address : " + Coaches_DataBase[i][0][1],
                        "Phone Number :" + Coaches_DataBase[i][0][2],
                    )
                ...
                for i in Members_DataBase:
                    print(
                        "	Member : "
                        + Members_DataBase[i][2]
                        + " in "
                        + Members_DataBase[i][0]
                        + " programme and followed by "
                        + Members_DataBase[i][1]
                        + ", age : "
                        + Members_DataBase[i][3]
                        + ", from : "
                        + Members_DataBase[i][5]
                        + ", Phone Number :"
                        + Members_DataBase[i][8]
                    )
